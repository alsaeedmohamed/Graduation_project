...
function FindDoctors() {
  ...
  const handleNavigate = () => {
    navigate("/src/pages/drinfo.jsx"); // استبدلي "/appointment" بالمسار الذي تريدين التوجيه إليه
  };
    ...
    return (
      ...
      <div className="bg-white shadow-md rounded-lg flex items-center  max-w-lg">
        ...
        <div className="flex-1 mr-5 font-poppins">
          <h3 className="text-lg font-poppins font-bold text-gray-800 text-left">Dr. Ahmed Shaaban</h3>
          <p className="text-sm text-gray-500 text-left">Neurologist | Mercy Hospital</p>
      ...
      <div className="bg-white shadow-md rounded-lg flex items-center  max-w-lg">
        ...
        {/* بيانات الطبيب */}
        <div className="flex-1 mr-5 font-poppins">
          <h3 className="text-lg font-poppins font-bold text-gray-800 text-left">Dr. Mohamed Elsayed</h3>
          <p className="text-sm text-gray-500 text-left">Neurologist | Mercy Hospital</p>
